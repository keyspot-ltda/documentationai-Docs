...
<Steps>
  <Step title="Solicite credenciais" icon="key">
    Abra um chamado no CRM com um usuário administrador para solicitar seu par `API Key` + `API Secret`. Acesse [https://crm.keyspot.com.br/support/tickets](https://crm.keyspot.com.br/support/tickets) e informe:
